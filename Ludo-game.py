#------------------------------------------------------------------------------------------------------------------
#Designed and created by Manish Sharma 
#------------------------------------------------------------------------------------------------------------------
...
import sys
import os
import random #random is imported to creare a random number
...
root.title("LUDO GAME")                    #Window title 
#------------------------------------------------------------------------------------------------------------------
logo = PhotoImage(file="whitebox.gif")      #image files required in game
...
#------------------------------------------------------------------------------------------------------------------
#after raking images arraging them to create a platform to play
#------------------------------------------------------------------------------------------------------------------
...
rollc = 0
rolls = []
RED = True  #red is given true because it is first player so remaining are false
BLUE = False
GREEN = False
YELLOW = False
TURN = True     
...
#------------------------------------------------------------------------------------------------------------------
    ...
    while (v != 300):
        z = 0
        while (z != 150):
            Label(image=logo, width=46, height=46).place(x=(300 + z), y=(0 + v))#placing whites b/w red and yellow at green
            z = z + 50
        v = v + 50
    z = 0
    v = 0
    while (v != 300):        
        z = 0
        while (z != 150):
            Label(image=logo, width=46, height=46).place(x=(0 + v), y=(300 + z))#placing white b/w blue and green at red
            z = z + 50
        v = v + 50
    v = 0
    z = 0
    while (v != 300):            #Drawing White boxes
        z = 0
        while (z != 150):
            Label(image=logo, width=46, height=46).place(x=(300 + z), y=(450 + v))#placing whites b/w red and yellow at blue
            z = z + 50
        v = v + 50
    z = 0
    v = 0
    while (v != 300):         #Drawing White boxes
        z = 0
        while (z != 150):
            Label(image=logo, width=46, height=46).place(x=(450 + v), y=(300 + z))#placing white b/w blue and green at yellow
            z = z + 50
        v = v + 50
#------------------------------------------------------------------------------------------------------------------
#green boxes drawing
...
#------------------------------------------------------------------------------------------------------------------
#Class which performs on yellow according to dice number
#------------------------------------------------------------------------------------------------------------------
class YBox:                               
    rap = None
...
#------------------------------------------------------------------------------------------------------------------
#Class which performs on green according to dice number same as yellow
#------------------------------------------------------------------------------------------------------------------
class GBox: 
    rap = None
    ...
    def swap(self):
        self.rap.place(x=self.x0 + 13, y=self.y0 + 14)
#------------------------------------------------------------------------------------------------------------------
#Class which performs on blue according to dice number same as yellow
#------------------------------------------------------------------------------------------------------------------
class BBox:                           
    rap = None
    ...
    def swap(self):
        self.rap.place(x=self.x0 + 13, y=self.y0 + 14)
#------------------------------------------------------------------------------------------------------------------
#Class which performs on red according to dice number same as yellow
#------------------------------------------------------------------------------------------------------------------
class Box:                          
    rap = None
...
def roll():   #Rolling function that rolls a dice, goes again if its a six
    ...
    if TURN == True:
        ...
        if rollc == 1:
            ...
            L1 = Label(root, text=dice, fg='Black', background='grey', font=("Arial", 24, "bold"))
        ...
        if rollc == 2:
            if dice == 6:
                ...
                L3 = Label(root, text=dice1, fg='Black', background='grey', font=("Arial", 24, "bold"))
        ...
        if rollc == 3:
            if dice1 == 6:
                ...
                L4 = Label(root, text=dice2, fg='Black', background='grey', font=("Arial", 24, "bold"))
...
def clear():        #clears all the variable prior to next player's turn
    ...
    del rolls[:]
    TURN = True
    L1 = Label(root, text="        ", fg='Black', background='grey', font=("Arial", 24, "bold"))
    L1.place(x=800, y=200)
    L3 = Label(root, text="        ", fg='Black', background='grey', font=("Arial", 24, "bold"))
    L3.place(x=800, y=250)
    L4 = Label(root, text="        ", fg='Black', background='grey', font=("Arial", 24, "bold"))
    L4.place(x=800, y=300)
    print("cleared")
    turn()
...
def movecheck(r, rh, rb, la):       #Check if the player can make a move
    ...
    if win == True:                                         #If all gamepieces home, prints that the player has won
        print("YOU HAVE WON")
        L2 = Label(root, text=(la + "Wins"), fg='Black', background='grey', font=("Arial", 24, "bold"))
